...
namespace BaseLib
{
    public class ChilkatHttpHelpr
    {
        ...
        public string PostData(string URL, string postData, string referer)
        {
            ...
            //req.AddHeader("User-Agent"," Mozilla/5.0 (Windows NT 6.1; rv:14.0) Gecko/20100101 Firefox/14.0.1");
            //req.AddHeader("Accept","text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8");
            //req.AddHeader("Accept-Language","en-us,en;q=0.5");
            //req.AddHeader("Accept-Encoding","gzip, deflate");
            //req.AddHeader("Connection","keep-alive");
            //req.AddHeader("Content-Type","application/x-www-form-urlencoded");
            //req.AddHeader("Content-Language","en");
            ...
            Chilkat.HttpResponse respUsingPostURLEncoded;
